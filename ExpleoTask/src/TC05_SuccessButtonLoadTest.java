...
public class TC05_SuccessButtonLoadTest {
    ...
    public static void main(String[] args) throws Exception{
        ...
        String expectedSuccessButtonLabel = "button success";
        String actualSuccessButtonLabel = "";
        ...
        actualSuccessButtonLabel = driver.findElement(By.xpath("/html/body/div[2]/div/div/div/div/div[1]/a[3]")).getAttribute("class");

        //Checks if the expected success button string matches the string from the actual success button
        if (actualSuccessButtonLabel.equals(expectedSuccessButtonLabel)){
